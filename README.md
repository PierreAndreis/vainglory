...
- `.stats` - an object with the following attributes:
   ...
   - `elo_earned_season_5` - meaning unclear
   - `elo_earned_season_6` - meaning unclear
   - `elo_earned_season_7` - meaning unclear
   - `elo_earned_season_8` - meaning unclear
   - `elo_earned_season_9` - meaning unclear
   ...
   - `played_blitz` - meaning unclear
   - `played_casual` - meaning unclear
   - `played_ranked` - meaning unclear
